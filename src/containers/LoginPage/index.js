    ...
    return (
      <div className="container-fluid">
        <div className="login-container-fixed">
          <div className="login-heading app-title">Star Wars Academy</div>
          <div className="login-heading">Sign In to enter the Galaxy</div>
          <form onSubmit={this.manageLogin}>
            <div className="input-group">
              <input type="text" required onChange={ (e)=>this.updateFields(e, "username") }/>
              <label className="input-group-addon label-txt"></label>
              <label className="label-txt">Enter Username</label>
            </div>
            <div className="input-group">
              <input type="password" required onChange={ (e)=>this.updateFields(e, "password") }/>
              <label className="input-group-addon label-txt"></label>
              <label className="label-txt">Enter Password</label>
            </div>
            <div className="text-center">
              <input type="submit" className="btn-blue" value="Continue" disabled={!(username && password)} />
            </div>
          </form>
        </div>
